Write a program to show working of a echo server.
...
from clients (strings until EOF is provided i.e persistent connection) and replies with reverse strings. For example, 
